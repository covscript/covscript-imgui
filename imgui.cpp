...
// Canvas
	...
	CNI_NAMESPACE(keys)
	{
		...
		CNI_VALUE_CONST_V(key_w, ImGuiKey, ImGuiKey_W)
		CNI_VALUE_CONST_V(key_a, ImGuiKey, ImGuiKey_A)
		CNI_VALUE_CONST_V(key_s, ImGuiKey, ImGuiKey_S)
		CNI_VALUE_CONST_V(key_d, ImGuiKey, ImGuiKey_D)
		CNI_VALUE_CONST_V(key_r, ImGuiKey, ImGuiKey_R)
		CNI_VALUE_CONST_V(key_p, ImGuiKey, ImGuiKey_P)
		CNI_VALUE_CONST_V(key_c, ImGuiKey, ImGuiKey_C)
		CNI_VALUE_CONST_V(key_0, ImGuiKey, ImGuiKey_0)
		CNI_VALUE_CONST_V(key_1, ImGuiKey, ImGuiKey_1)
		CNI_VALUE_CONST_V(key_2, ImGuiKey, ImGuiKey_2)
		CNI_VALUE_CONST_V(key_3, ImGuiKey, ImGuiKey_3)
		CNI_VALUE_CONST_V(key_4, ImGuiKey, ImGuiKey_4)
		CNI_VALUE_CONST_V(key_5, ImGuiKey, ImGuiKey_5)
		CNI_VALUE_CONST_V(key_6, ImGuiKey, ImGuiKey_6)
		CNI_VALUE_CONST_V(key_7, ImGuiKey, ImGuiKey_7)
		CNI_VALUE_CONST_V(key_8, ImGuiKey, ImGuiKey_8)
		CNI_VALUE_CONST_V(key_9, ImGuiKey, ImGuiKey_9)
		CNI_VALUE_CONST_V(left_shift, ImGuiKey, ImGuiKey_LeftShift)
		CNI_VALUE_CONST_V(left_ctrl, ImGuiKey, ImGuiKey_LeftCtrl)
	}
